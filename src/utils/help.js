...
export const help = () => {
  ...
  helpData.cd = new Command("cd path_to_directory", "Go to a dedicated folder from the current directory");
  helpData.ls = new Command("ls", "List all files and folders in the current directory");
  ...
  helpData.hash = new Command("hash file_path", "Calculate the hash for the file");
